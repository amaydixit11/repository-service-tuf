...
python ${UMBRELLA_PATH}/tests/functional/scripts/rstuf-admin-ceremony.py '{
    ...
    "[select] (online keys) Info: manage the online key collection (continue/add/remove)": "continue",
    ...
    "[input file] (cdr 2) Please enter path to public key": "tests/files/key_storage/JJ.pub",
    ...
    "[input file] (cdr 2) (signer 2) Please enter path to public key": "tests/files/key_storage/JH.pub",
...
if [[ ${METADATA_BASE_URL} =~ "localstack" ]]; then
    ...
    "[select] Info: Threshold 2 is met, more keys can be added (continue/add/remove)": "continue",
    "[select] (online keys 1) manage the collection (continue/add/remove)": "remove",
    "[select] (online keys) Select an online key to remove": "online1",
    "[select] (online keys 2) manage the collection (continue/add/remove)": "add",
    "[select] Select Online Key type": "AWS KMS",
    "AWS KMS KeyID": "alias/kms-rstuf-online-1",
    "Please enter key name": "online kms 1",
    "[select] (online keys 3) manage the collection (continue/add/remove)": "continue",
